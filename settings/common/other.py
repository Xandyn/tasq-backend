...
MAIL_USE_TLS = True if MAIL_USERNAME else False
MAIL_PORT = 587 if MAIL_USERNAME else 25
MAIL_SERVER = os.getenv('MAIL_SERVER', 'smtp.gmail.com') if MAIL_USERNAME else 'localhost'
